...
package com.fastaccess.tfl.ui.wallpaper;
...
import com.fastaccess.tfl.ui.wallpaper.gallery3d.common.BitmapCropTask;
import com.fastaccess.tfl.ui.wallpaper.gallery3d.common.BitmapUtils;
import com.fastaccess.tfl.ui.wallpaper.gallery3d.common.Utils;
import com.fastaccess.tfl.ui.wallpaper.photos.BitmapRegionTileSource;
import com.fastaccess.tfl.ui.wallpaper.photos.BitmapRegionTileSource.BitmapSource;
import com.fastaccess.tfl.ui.wallpaper.photos.BitmapRegionTileSource.BitmapSource.InBitmapProvider;
import com.fastaccess.tfl.ui.wallpaper.photos.views.TiledImageRenderer.TileSource;
...
public class WallpaperCropActivity extends WallpaperBaseActivity implements Handler.Callback {
    ...
    /**
     * The maximum bitmap size we allow to be returned through the intent. Intents have a maximum of 1MB in total size. However, the Bitmap seems to
     * have some overhead to hit so that we go way below the limit here to make sure the intent stays below 1MB.We should consider just returning a
     * byte array instead of a Bitmap instance to avoid overhead.
     */
    ...
    void addReusableBitmap(TileSource src) {
        synchronized (mReusableBitmaps) {
    ...
    protected void updateWallpaperDimensions(int width, int height) {
        String spKey = WALLPAPER_CROP_PREFERENCES_KEY;
