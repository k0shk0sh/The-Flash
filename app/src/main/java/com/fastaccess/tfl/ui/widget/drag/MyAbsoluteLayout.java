 ...
 * other types of layouts without absolute positioning. <p> Attributes}</p>
 * <p>
...
public class MyAbsoluteLayout extends ViewGroup {
    ...
    /**
     * Returns a set of layout parameters with a width of {@link ViewGroup.LayoutParams#WRAP_CONTENT}, a height of {@link
     * ViewGroup.LayoutParams#WRAP_CONTENT} and with the coordinates (0, 0).
     */
    @Override
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
         ...
         *
         * @param width
         *         the width, either {@link #MATCH_PARENT}, {@link #WRAP_CONTENT} or a fixed size in pixels
         * @param height
         *         the height, either {@link #MATCH_PARENT}, {@link #WRAP_CONTENT} or a fixed size in pixels
         * @param x
         ...
         * <p>
         * <ul> <li><code>layout_x</code>: the X location of the child</li> <li><code>layout_y</code>: the Y location of the child</li> <li>All the
         * XML attributes from {@link ViewGroup.LayoutParams}</li> </ul>
         *
         * @param c
