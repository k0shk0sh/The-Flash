...
public interface DropTarget {
     ...
     * @param xOffset
     *         Horizontal offset with the object being dragged where the original touch happened
     * @param yOffset
     *         Vertical offset with the object being dragged where the original touch happened
     * @param dragView
    ...
    /**
     * Check if a drop action can occur at, or near, the requested location. This may be called repeatedly during a drag, so any calls should return
     * quickly.
     *
     * @param source
     *         DragSource where the drag started
     ...
     * @return Estimated area that would be occupied if object was dropped at the given location. Should return null if no estimate is found, or if
     * this target doesn't provide estimations.
     */
