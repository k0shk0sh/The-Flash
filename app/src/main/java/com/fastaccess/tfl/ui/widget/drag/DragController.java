...
public class DragController {
    ...
    interface DragListener {
         ...
         * @param dragAction
         *         The drag action: either {@link DragController#DRAG_ACTION_MOVE} or {@link DragController#DRAG_ACTION_COPY}
         */
    ...
    /**
     * Starts a drag. It creates a bitmap of the view being dragged. That bitmap is what you see moving. The actual view can be repositioned if that
     * is what the onDrop handle chooses to do.
     *
     * @param v
     ...
     *
     * @param b
     *         The bitmap to display as the drag image.  It will be re-scaled to the enlarged size.
     * @param screenX
