...
public class Partner {
    ...
    private static final String
            ACTION_PARTNER_CUSTOMIZATION = "com.fastaccess.tfl.ui.wallpaper.action.PARTNER_CUSTOMIZATION";
    ...
    public void applyInvariantDeviceProfileOverrides(DisplayMetrics dm) {
        int numRows = -1;
        int numColumns = -1;
        float iconSize = -1;
