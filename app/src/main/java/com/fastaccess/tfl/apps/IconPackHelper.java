            ...
            builder.setAdapter(adapter, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    try {
                        ...
                        Toast.makeText(context, "Icon pack not supported!", Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
